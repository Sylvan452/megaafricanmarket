...
const Terms = () => {
  return (
    <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-4">
        <p>
          This website is operated by Mega African Market. Throughout the site,
          the terms “we,” “us,” and “our” refer to Mega African Market. Mega
          African Market offers this website, including all information, tools,
          ...
          stated here. By visiting our site and/or purchasing something from us,
          you engage in our “Service” and agree to be bound by the following
          terms and conditions (“Terms of Service” or “Terms”), including any
          additional terms and conditions and policies referenced herein and/or
          available by hyperlink. These Terms apply to all users of the site,
          including browsers, vendors, customers, merchants, and contributors of
        ...
        these Terms. If you do not agree to all the terms and conditions of this
        ...
        these Terms. Any new features or tools added to the current store shall
        also be subject to these Terms. You can review the most current version
        of the Terms of Service at any time on this page. We reserve the right
        to update, change, or replace any part of these Terms by posting updates
        and/or changes to our website. It is your responsibility to check this
        page periodically for changes. Your continued use of or access to the
        website following the posting of any changes constitutes acceptance of
        those changes. Our store is hosted on Hostiger, which provides us with
        ...
        <p>
          ...
          1.<b>
            {' '}
            Online Store Terms By agreeing to these Terms of Service,
          </b>{' '}
          you represent that you are at least the age of majority in your state
          or province of residence, or that you are the age of majority in your
          ...
          any worms, viruses, or any code of a destructive nature. A breach or
          violation of any of the Terms will result in an immediate termination
          of your Services.{' '}
        </p>
        2.{' '}
        <b>
          General Conditions We reserve the right to refuse service to anyone
        ...
        <p>
          {' '}
          3. <b>Accuracy, Completeness, and Timeliness of Information.</b> We
          ...
          may contain certain historical information. Historical information is
        ...
        4. <b>Modifications to the Service and Prices for our products:</b> are
        subject to change without notice. We reserve the right at any time to
        modify or discontinue the Service (or any part or content thereof)
        without notice. We shall not be liable to you or any third-party for any
        modification, price change, suspension, or discontinuance of the
        Service.{' '}
        <p>
          5.<b> Products or Services (if applicable):</b> Certain products or
          ...
          that your computer monitor&apos s display of any color will be
        ...
        6. <b>Accuracy of Billing and Account Information: </b> We reserve the
        ...
        resellers, or distributors. You agree to provide current, complete, and
        accurate purchase and account information for all purchases made at our
        ...
        <p>
          7. <b>Optional Tools:</b> We may provide you with access to
          ...
          new tools and resources). Such new features and/or services shall also
          be subject to these Terms of Service.
        </p>{' '}
        8. <b>Third-Party Links:</b> Certain content, products, and services
        ...
        parties. We are not liable for any harm or damages related to the
        ...
        review carefully the third-party&apos s policies and practices and make
        ...
        <p>
          {' '}
          9. <b>User Comments, Feedback, and Other Submissions:</b> If, at our
          ...
          &aposcomments&apos), you agree that we may, at any time, without
          ...
          edit, or remove content that we determine in our sole discretion to be
          ...
          intellectual property or these Terms of Service. You agree that your
          ...
          contain libelous or otherwise unlawful, abusive, or obscene material,
        ...
        SECTION 10 -<b> PERSONAL INFORMATION:</b> Your submission of personal
        information through the store is governed by our Privacy Policy. To view
        our Privacy Policy.{' '}
        <p>
          SECTION 11 - <b>ERRORS, INACCURACIES AND OMISSIONS:</b> Occasionally
        ...
        SECTION 12 - <b>PROHIBITED USES:</b> In addition to other prohibitions
        as set forth in the Terms of Service, you are prohibited from using the
        site or its content: (a) for any unlawful purpose; (b) to solicit others
        to perform or participate in any unlawful acts; (c) to violate any
        ...
        <p>
          SECTION 13 - <b>DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY:</b>{' '}
          ...
          service are (except as expressly stated by us) provided &aposas
          is&apos and &aposas available&apos for your use, without any
          ...
          Mysasun, our directors, officers, employees, affiliates, agents,
        ...
        SECTION 14 - <b>INDEMNIFICATION:</b> You agree to indemnify, defend and
        hold harmless Mysasun and our parent, subsidiaries, affiliates,
        ...
        <p>
          {' '}
          SECTION 15 - <b>SEVERABILITY:</b> In the event that any provision of
          ...
          portion shall be deemed to be severed from these Terms of Service,
          such determination shall not affect the validity and enforceability of
          any other remaining provisions.
        </p>
        SECTION 16 - <b>TERMINATION:</b> The obligations and liabilities of the
        ...
        longer wish to use our Services, or when you cease using our site. If in
        our sole judgment you fail, or we suspect that you have failed, to
        ...
        thereof).
        <p>
          SECTION 17 - <b>ENTIRE AGREEMENT:</b> The failure of us to exercise or
          ...
          and any policies or operating rules posted by us on this site or in
        ...
        SECTION 18 - <b>GOVERNING LAW:</b> These Terms of Service and any
        separate agreements whereby we provide you Services shall be governed by
        and construed in accordance with the laws of United States.
        <p>
          {' '}
          SECTION 19 - <b>CHANGES TO TERMS OF SERVICE:</b> You can review the
