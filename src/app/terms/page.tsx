  ...
  return (
    <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <p className="mb-4">
        ...
        <p>
          {' '}
          1. Online Store Terms By agreeing to these Terms of Service, you
        ...
        2. General Conditions We reserve the right to refuse service to anyone
        for any reason at any time. You understand that your content (not
        including credit card information) may be transferred unencrypted and
        involve transmissions over various networks and changes to conform and
        ...
        <p>
          {' '}
          3. Accuracy, Completeness, and Timeliness of Information We are not
        ...
        4. Modifications to the Service and Prices Prices for our products are
        ...
        Service.{' '}
        <p>
          5. Products or Services (if applicable) Certain products or services
          may be available exclusively online through the website. These
        ...
        6. Accuracy of Billing and Account Information We reserve the right to
        ...
        billing and/or shipping address. In the event that we make a change to
        or cancel an order, we may attempt to notify you by contacting the
        ...
        <p>
          7. Optional Tools We may provide you with access to third-party tools
          ...
          “as available” without any warranties, representations, or conditions
        ...
        via our Service may include materials from third parties. Third-party
        ...
        third-party&apos s policies and practices and make sure you understand
        ...
        <p>
          {' '}
          9. User Comments, Feedback, and Other Submissions If, at our request,
          you send certain specific submissions (for example contest entries) or
          ...
          postal mail, or otherwise (collectively, &aposcomments&apos), you
        ...
        <p>
          SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY We do
          ...
          (except as expressly stated by us) provided &aposas is&apos and
          &aposas available&apos for your use, without any representation,
          warranties or conditions of any kind, either express or implied,
          including all implied warranties or conditions of merchantability,
          merchantable quality, fitness for a particular purpose, durability,
          title, and non-infringement. In no case shall Mysasun, our directors,
        ...
        harmless Mysasun and our parent, subsidiaries, affiliates, partners,
        ...
        use our Services, or when you cease using our site. If in our sole
