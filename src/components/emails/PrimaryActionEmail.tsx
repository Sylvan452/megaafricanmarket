...
export const EmailTemplate = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your marketplace for high-quality Grecories.</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            Welcome to Mega African Market, the marketplace for high quality
            grecories. Use the button below to {actionLabel}.
          </Text>
